...
public final class WorkServiceMain {
    ...
    private static Element getAssertion() throws Exception {
        ...
        WSTrustClient client = new WSTrustClient("PicketLinkSTS", "PicketLinkSTSPort", "http://"+serverHostname+"/picketlink-sts/PicketLinkSTS", new SecurityInfo(userId, password));
